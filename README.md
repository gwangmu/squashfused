...
"Squashfused" almost sounds like a new Linux kernel vulnerability, but keep calm. It's a tool, not a vulnerability. It was supposed to be short for "Squashfuse-delegate." If it's relevant, you can pronounce it whichever way you prefer: "Squashfused" or "Squashfuse-Dee."
...
### Prerequisite
 ...
 - Your host system and container image should have `bash` (requirement eliminable in the future).
